...
export type PaymentOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "rentalRequestId" | "userId" | "transactionId" | "amount" | "provider" | "status" | "paidAt" | "createdAt", ExtArgs["result"]["payment"]>;
